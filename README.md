...
<p align="center">
  <img src="Screenshot%202026-0-11%200216445.jpeg" alt="Bengaluru House Price Analysis Dashboard" width="100%">
</p>
...
- Distribution of Houses by Area Type
- Built-up Area
- Carpet Area
- Plot Area
- Super Built-up Area
...
```text
Bengaluru-House-Price-Analysis-Excel-Dashboard/
│
├── Bengaluru House Price Analysis Dashboard.xlsx
├── Bengaluru House Price Analysis.ipynb
├── Raw_Dataset.csv
├── Cleaned_Dataset.csv
├── Dashboard.png
├── README.md
